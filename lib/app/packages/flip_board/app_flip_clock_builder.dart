...
class AppFlipClockBuilder {
  ...
  Widget _buildUnitsDisplay(Stream<int> timePartStream, int initialValue) => _buildDisplay(
        timePartStream.map<int>((value) => value % 10),
        initialValue % 10,
      );
  ...
  Widget _buildDisplay(Stream<int> digitStream, int initialValue) => Column(
        ...
        children: [
          Padding(
            ...
            child: AppFlipWidget<int>(
              flipType: AppFlipType.middleFlip,
              ...
              flipCurve: flipCurve ?? AppFlipWidget.defaultFlip,
            ),
          ),
        ],
      );
        ...
        children: [
          Padding(
            ...
            child: Container(
              ...
              child: Text(
                ':',
                style: TextStyle(fontSize: digitSize - 4, color: separatorColor ?? Theme.of(context).colorScheme.onPrimary),
              ),
            ),
          ),
        ],
