...
/// There two types of Flip Animations for [AppFlipWidget].
///
...
class AppFlipWidget<T> extends StatefulWidget {
  ...
  @override
  State<AppFlipWidget<T>> createState() => flipType == AppFlipType.middleFlip ? _MiddleFlipWidgetState<T>() : _SpinFlipWidgetState<T>();
}

abstract class _AppFlipWidgetState<T> extends State<AppFlipWidget<T>> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant AppFlipWidget<T> oldWidget) {
  ...
  Widget firstFlatPanel(AxisDirection direction) =>
      direction == AxisDirection.up || direction == AxisDirection.left ? _firstPanelChild1 : _firstPanelChild2;

  Widget secondFlatPanel(AxisDirection direction) =>
      direction == AxisDirection.up || direction == AxisDirection.left ? _secondPanelChild2 : _secondPanelChild1;
...
/// Parameters are documented in [AppFlipWidget] class constructor.
class _MiddleFlipWidgetState<T> extends _AppFlipWidgetState<T> {
  @override
  Widget buildFirstFlipPanel() {
  ...
  @override
  Transform? transform2FirstPanel(AxisDirection direction) {
    final isPastMiddle = _flipAnimation.value > _AppFlipWidgetState._piBy2;
...
class _SpinFlipWidgetState<T> extends _AppFlipWidgetState<T> {
  @override
  Widget buildFirstFlipPanel() {
    final movingPanel = transform2FirstPanel(widget.flipDirection);
