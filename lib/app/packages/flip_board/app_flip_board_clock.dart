...
import 'app_flip_clock_builder.dart';
...
class AppFlipCountdownClock extends StatelessWidget {
  ...
  AppFlipCountdownClock({
    ...
    this.onDone,
        ...
        _displayBuilder = AppFlipClockBuilder(
          digitSize: digitSize,
          width: width,
          height: height,
          ...
          hingeLength: hingeWidth == 0.0
              ? 0.0
              : hingeLength ?? (flipDirection == AxisDirection.down || flipDirection == AxisDirection.up ? width : height),
  ...
  final AppFlipClockBuilder _displayBuilder;
